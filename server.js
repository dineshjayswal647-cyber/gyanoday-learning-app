      ...
      notifications: [
        {
          id: 1,
          type: "system",
          text: "DJ Learning Academy सर्वर सफलतापूर्वक चालू हो गया है!",
...
function sendWebhookNotification(payload) {
  ...
  if (typeof payload === 'object') {
    ...
    postData = JSON.stringify({
      content: `🔔 **DJ Learning Academy Alert:** ${payload}`
    });
  }
...
app.post('/api/auth/send-otp', (req, res) => {
  ...
  if (apiKey) {
    ...
    if (senderId && templateId) {
      ...
      url = `https://www.fast2sms.com/dev/bulkV2?route=q&message=${encodeURIComponent("DJ Learning Academy verification code is " + otp)}&numbers=${phone}`;
    }
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`===========================================================`);
  console.log(`DJ Learning Academy Full-Stack server is active!`);
